defmodule Marvin.SmartThing.ActuatorConfig do
	...
	def new(name: name, type: type, specs: specs, activations: activations) do
		config = %Marvin.SmartThing.ActuatorConfig{name: name,
																 type: type,
																 specs: specs,
																 activations: activations}
		%Marvin.SmartThing.ActuatorConfig{config | intents: intent_names(config.activations)}
	end
